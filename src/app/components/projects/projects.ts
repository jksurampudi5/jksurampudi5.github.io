...
export class ProjectsComponent {
  // Ordered descending from most recent (NOUS) to earliest (COGNIZANT)
  companies: string[] = [
    'NOUS INFOSYSTEMS',
    'SYNECHRON',
    'CES LTD',
  ...
  // Default active company is Nous Infosystems (most recent)
  selectedCompany: string = 'NOUS INFOSYSTEMS';
